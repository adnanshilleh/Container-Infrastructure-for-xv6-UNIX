...
extern int sys_setroot(void);	// Container Manager
...
static int (*syscalls[])(void) = {
  ...
  [SYS_close] sys_close, [SYS_setroot] sys_setroot, [SYS_shm_get] sys_shm_get, [SYS_shm_rem] sys_shm_rem,
  [SYS_mutex_create] sys_mutex_create, [SYS_mutex_delete] sys_mutex_delete, [SYS_mutex_lock] sys_mutex_lock, 
